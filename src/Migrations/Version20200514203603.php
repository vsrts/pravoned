 ...
 */
final class Version20200514203603 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, property_type_id INT DEFAULT NULL, category_id INT DEFAULT NULL, location_id INT DEFAULT NULL, agent_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_8BF21CDE77153098 (code), INDEX IDX_8BF21CDEC54C8C93 (type_id), INDEX IDX_8BF21CDE9C81C6EB (property_type_id), INDEX IDX_8BF21CDE12469DE2 (category_id), UNIQUE INDEX UNIQ_8BF21CDE64D218E (location_id), INDEX IDX_8BF21CDE3414710B (agent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
